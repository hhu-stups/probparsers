...
public class ExpressionTest {
	...
	public void testEmptySequence2() throws Exception {
		...
		final String result3 = Helpers.getTreeAsString(testMachine3);
	...
	public void testConcat() throws Exception {
		final String result = Helpers.getTreeAsString("#EXPRESSION s^t");
		assertEquals("Start(AExpressionParseUnit(AConcatExpression(AIdentifierExpression([s]),AIdentifierExpression([t]))))", result);
	}

	@Test
	public void testString() throws Exception {
		final String result = Helpers.getTreeAsString("#EXPRESSION \"test\"");
		assertEquals("Start(AExpressionParseUnit(AStringExpression(test)))", result);
	}

	@Test
	public void testEmptyString() throws Exception {
		final String result = Helpers.getTreeAsString("#EXPRESSION \"\"");
		assertEquals("Start(AExpressionParseUnit(AStringExpression()))", result);
	}

	@Test
	public void testComprehensionSets() throws BCompoundException {
		final String expected = "Start(AExpressionParseUnit(AComprehensionSetExpression([AIdentifierExpression([i])],AGreaterPredicate(AIdentifierExpression([i]),AIntegerExpression(0)))))";
		final String standard = Helpers.getTreeAsString("#EXPRESSION {i|i>0}");
	...
	public void testProverComprehensionSets() throws BCompoundException {
		...
		final String expected = "Start(AExpressionParseUnit(AProverComprehensionSetExpression([AIdentifierExpression([i])],AGreaterPredicate(AIdentifierExpression([i]),AIntegerExpression(0)))))";
		...
		assertEquals(expected, ast2String.toString());
	...
	public void testRelationalImagePrio() throws BCompoundException {
		final String actual = Helpers.getTreeAsString("#EXPRESSION c~[s]*x");
		final String expected = "Start(AExpressionParseUnit(AMultOrCartExpression(AImageExpression(AReverseExpression(AIdentifierExpression([c])),AIdentifierExpression([s])),AIdentifierExpression([x]))))";
		assertEquals(expected, actual);
	}

	@Test
	public void testLargeInteger() throws BCompoundException {
		final String actual = Helpers.getTreeAsString("#EXPRESSION 922337203685477580756");
		final String expected = "Start(AExpressionParseUnit(AIntegerExpression(922337203685477580756)))";
		assertEquals(expected, actual);
	}
}
