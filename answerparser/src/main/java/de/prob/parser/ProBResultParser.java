...
public final class ProBResultParser {
	...
	public static Start parse(final String prologAnswer) {
		...
		try {
			...
			String message =
				"Internal Error while parsing ProB answer. This ist most likely a bug in the " + "Result" + "-Parser. " +
					"String was: '" + prologAnswer + "'. Last Token was '" + e.getToken() + "': " + e.getLocalizedMessage();
			throw new ResultParserException(message, e);
		} catch (final LexerException e) {
			String message =
				"Internal Error while parsing ProB answer. This ist most likely a bug in the " + "Result" + "-Parser " +
					"String was: '" + prologAnswer + "': " + e.getLocalizedMessage();
			throw new ResultParserException(message, e);
